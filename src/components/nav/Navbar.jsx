...
const Navbar = () => {
  ...
  const active = 'text-lg font-bold px-6 p-y-3 bg-pink-500 rounded-md';
  ...
  return (
    <div>
      <header className=" mx-auto bg-white max-w-7xl boder-b sticky top-0 z-50">
        ...
        <div>
          <a href='/' className='flex py-3 px-6 item-center gap-1 text-lg font-mono fonto-bold shadow-md shadow-purple-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none rounded-lg mr-3'>
  ...
  <path fill-rule="evenodd" d="M3 6.75A.75.75 0 0 1 3.75 6h16.5a.75.75 0 0 1 0 1.5H3.75A.75.75 0 0 1 3 6.75ZM3 12a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75A.75.75 0 0 1 3 12Zm0 5.25a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75a.75.75 0 0 1-.75-.75Z" clip-rule="evenodd" />
        ...
        <a href='/login' className='hidden md:block items-center justify-center px-4 py-2 text-lg font-mono font-medium text-white bg-pink-500 rounded-md hover:bg-pink-400'>Login</a>
