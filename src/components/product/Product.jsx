...
import Shirt from '../../assets/images/coporate.jpeg'
        ...
        <div class="flex flex-col md:flex-row -mx-4">
            <div class="md:flex-1 px-4">
                <div class="h-[460px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
                    <img class="w-full h-full object-cover" src={Shirt} />
                </div>
            ...
            <div class="md:flex-1 px-4">
                ...
                <div>
                    ...
                    Elevate your team's presence with our timeless corporate shirt. Its crisp lines and impeccable tailoring convey confidence and sophistication, making a lasting impression in any business setting.
                    </p>
                </div>
            </div>
        </div>
